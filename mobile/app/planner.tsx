    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        <View style={styles.placeholderCard}>
          <MaterialIcons name="event-note" size={48} color={colors.primary} />
          <Text style={styles.title}>Season-Window & Trip Planner</Text>
          <Text style={styles.sub}>
            Plan expedition timelines, team size allocation, and station target milestones.
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
