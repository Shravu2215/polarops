  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.topHeader}>
        ...
        <Text style={styles.headerTitle}>Cargo & Loading Optimizer</Text>
        <View style={{ width: 24 }} />
      </View>

      <ScrollView contentContainerStyle={styles.content}>
        <View style={styles.placeholderCard}>
          <MaterialIcons name="local-shipping" size={48} color={colors.accentOrange} />
          <Text style={styles.title}>Cargo Tracking & OR-Tools Optimizer</Text>
          <Text style={styles.sub}>
            Ship weight/volume knapsack loading optimization & QoS 1 cargo sync tracking.
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
